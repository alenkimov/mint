...
Revision ID: 93625f78a60d
Revises: 
Create Date: 2024-03-23 02:06:07.879044
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_mint_account_group_name"),
        "mint_account",
        ["group_name"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_mint_account_group_name"), table_name="mint_account"
    )
