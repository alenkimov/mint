...
class BadLoginCookies(FailedToLogin):
    """Исключение, вызываемое если не получилось залогиниться по причине неверных cookies."""
    pass
...
class TotpSecretRequired(FailedToLogin):
    pass
